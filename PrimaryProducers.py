...
SoyBeans = PP(mass_per_organism=231.2, organism_per_acre=100000, acre=2)
BottleGourds = PP(mass_per_organism=10000, organism_per_acre=600, acre=0.5)
Hemp = PP(mass_per_organism=5101, organism_per_acre=3000, acre=11)
Poppy = PP(mass_per_organism=499, organism_per_acre=21700, acre=2)
...
Ferns = PP(mass_per_organism=554.8, organism_per_acre=21700, acre=10)
